    ...
    <div className="!bg-white !min-h-screen !py-8 !px-4">
      <div className="!w-full !mx-auto !max-w-4xl">
        ...
        <p className="!text-blue-800 !mb-8 !text-center !text-lg">
          ...
          even brain function. A well-balanced gut microbiome can lead to better
          energy, improved mental clarity, and a stronger immune system.
        </p>
        ...
        <p className="!text-blue-800 !leading-relaxed !mb-8">
          ...
          nutrients with help from the liver, pancreas, and gallbladder.
        ...
        <p className="!text-blue-800 !leading-relaxed !mb-8">
          ...
          function. When your gut is healthy, you feel more balanced and
          energized. However, an unhealthy gut can contribute to anxiety,
        ...
        <p className="!text-blue-800 !mb-4">
          ...
          artificial sweeteners, which can harm your gut microbiome and promote
          inflammation.
        </p>
        ...
        <p className="!text-blue-800 !mb-4">
          ...
          bacteria and prevents harmful substances from entering your
          bloodstream.
        </p>
        ...
        <p className="!text-blue-800 !mb-8">
          ...
          restore your gut microbiome more quickly.
        </p>
        ...
        <p className="!text-blue-800">
          ...
          you're investing in your long-term health and well-being. Small daily
          choices can lead to profound improvements in how you feel and
          function. Listen to your gut—it's trying to tell you something
          important!
        </p>
      </div>
    </div>
